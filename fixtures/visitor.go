...
var _ configkit.PortableVisitor = (*PortableVisitor)(nil)

// PortableVisitor is an mock implementation of configkit.PortableVisitor.
type PortableVisitor struct {
	VisitPortableApplicationFunc func(context.Context, configkit.PortableApplication) error
	VisitPortableAggregateFunc   func(context.Context, configkit.PortableAggregate) error
	VisitPortableProcessFunc     func(context.Context, configkit.PortableProcess) error
	VisitPortableIntegrationFunc func(context.Context, configkit.PortableIntegration) error
	VisitPortableProjectionFunc  func(context.Context, configkit.PortableProjection) error
}

// VisitPortableApplication calls v.VisitApplicationFunc(ctx, cfg) if it is non-nil.
//
// If v.VisitPortableApplicationFunc is nil, each of the handlers in cfg is visited.
func (v *PortableVisitor) VisitPortableApplication(ctx context.Context, cfg configkit.PortableApplication) error {
	if v.VisitPortableApplicationFunc != nil {
		return v.VisitPortableApplicationFunc(ctx, cfg)
	}

	for _, h := range cfg.PortableHandlers() {
		if err := h.AcceptPortableVisitor(ctx, v); err != nil {
			return err
		}
	}
...
// VisitPortableAggregate calls v.VisitAggregateFunc(ctx, cfg) if it is non-nil.
func (v *PortableVisitor) VisitPortableAggregate(ctx context.Context, cfg configkit.PortableAggregate) error {
	if v.VisitPortableAggregateFunc == nil {
		return nil
	}

	return v.VisitPortableAggregateFunc(ctx, cfg)
}

// VisitPortableProcess calls v.VisitProcessFunc(ctx, cfg) if it is non-nil.
func (v *PortableVisitor) VisitPortableProcess(ctx context.Context, cfg configkit.PortableProcess) error {
	if v.VisitPortableProcessFunc == nil {
		return nil
	}

	return v.VisitPortableProcessFunc(ctx, cfg)
}

// VisitPortableIntegration calls v.VisitIntegrationFunc(ctx, cfg) if it is non-nil.
func (v *PortableVisitor) VisitPortableIntegration(ctx context.Context, cfg configkit.PortableIntegration) error {
	if v.VisitPortableIntegrationFunc == nil {
		return nil
	}

	return v.VisitPortableIntegrationFunc(ctx, cfg)
}

// VisitPortableProjection calls v.VisitProjectionFunc(ctx, cfg) if it is non-nil.
func (v *PortableVisitor) VisitPortableProjection(ctx context.Context, cfg configkit.PortableProjection) error {
	if v.VisitPortableProjectionFunc == nil {
		return nil
	}

	return v.VisitPortableProjectionFunc(ctx, cfg)
}
